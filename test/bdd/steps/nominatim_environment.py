...
class NominatimEnvironment:
    ...
    def setup_api_db(self):
        ...
        # ensure that the tokenizer files are copied into the project directory
        tokenizer_factory.create_tokenizer_directory(self.get_test_config(),
                                                     self.src_dir / 'lib-sql',
                                                     self.src_dir / 'lib-php')
